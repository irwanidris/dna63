...
class Attribute = AttributeBase with _$Attribute;
...
abstract class AttributeBase with Store {
  int? id;
  String? name;
  List<String>? options;
  String? optionString;
  ...
  AttributeBase({this.id, this.name, this.options, this.position, this.variation, this.visible, this.dropDownValue, this.optionString});

  AttributeBase.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
