...
class GroupModel {
  ...
  factory GroupModel.fromJson(Map<String, dynamic> json) {
    return GroupModel(
      ...
      groupAvatarImage: json['group_avtar_image'] is String ? json['group_avtar_image'] : '',
      ...
      memberCount: json['member_count'] is int ? json['member_count'] : int.tryParse(json['member_count'].toString()),
      ...
      postList: json['posts'] is List ? List<PostModel>.from(json['posts'].map((x) => PostModel.fromJson(x))) : [],
      isForumEnable: json['enable_forum'],
    );
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['enable_forum'] = this.isForumEnable;
