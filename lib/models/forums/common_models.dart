...
class GroupDetail {
  ...
  GroupDetail({this.createdAtDate, this.createdById, this.createdByName, this.groupId, this.isGroupMember = false, this.coverImage});
  ...
  factory GroupDetail.fromJson(Map<String, dynamic> json) {
    return GroupDetail(
      ...
      isGroupMember: json['is_group_member'] is bool ? json['is_group_member'] : false,
...
class TopicReplyModel {
  ...
  TopicReplyModel({this.children, this.content, this.createdAtDate, this.createdById, this.createdByName, this.id, this.key, this.replyTo, this.title, this.topicId, this.topicName, this.profileImage, this.isUserVerified, this.tag, this.image});
  ...
  factory TopicReplyModel.fromJson(Map<String, dynamic> json) {
    return TopicReplyModel(
      ...
      tag: json['tag'] != null ? (json['tag'] as List).map((i) => TagsModel.fromJson(i)).toList() : <TagsModel>[],
