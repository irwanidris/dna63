...
class GeneralSettingModel {
  ...
  List<GamipressAchievementTypes> gamipressRankTypes;
  List<GamipressAchievementTypes> gamipressPointsTypes;
  ...
  GeneralSettingModel({
    ...
    this.gamipressPointsTypes = const <GamipressAchievementTypes>[],
    this.gamipressRankTypes = const <GamipressAchievementTypes>[],
    this.pluginModel,
  });
  ...
  factory GeneralSettingModel.fromJson(Map<String, dynamic> json) {
    return GeneralSettingModel(
      ...
      gamipressPointsTypes: json['gamipress_points_types'] is List ? List<GamipressAchievementTypes>.from(json['gamipress_points_types'].map((x) => GamipressAchievementTypes.fromJson(x))) : [],
      gamipressRankTypes: json['gamipress_rank_types'] is List ? List<GamipressAchievementTypes>.from(json['gamipress_rank_types'].map((x) => GamipressAchievementTypes.fromJson(x))) : [],
      pluginModel: json['plugin_status'] != null ? PluginModel.fromJson(json['plugin_status']) : null,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'gamipress_rank_types': gamipressRankTypes.map((e) => e.toJson()).toList(),
      'gamipress_points_types': gamipressPointsTypes.map((e) => e.toJson()).toList(),
    };
  }
}
...
class PluginModel {
  int? acf;
  int? bbpress;
  int? bpBetterMessages;
  int? buddypress;
  int? wc4bp;
  int? contactForm7;
  int? elementor;
  int? wooCommerceProductFilter;
  int? iqonicExtensions;
  int? iqonicModerationTools;
  int? learnPress;
  int? mailChimpForWordPress;
  int? mediaPress;
  int? miniOrangeLoginOpenId;
  int? bpVerifiedMember;
  int? wpStoryPremium;
  int? wooSmartQuickView;
  int? yithWoocommerceWishlist;

  PluginModel(
      {this.acf,
      this.bbpress,
      this.bpBetterMessages,
      this.buddypress,
      this.wc4bp,
      this.contactForm7,
      this.elementor,
      this.wooCommerceProductFilter,
      this.iqonicExtensions,
      this.iqonicModerationTools,
      this.learnPress,
      this.mailChimpForWordPress,
      this.mediaPress,
      this.miniOrangeLoginOpenId,
      this.bpVerifiedMember,
      this.wpStoryPremium,
      this.wooSmartQuickView,
      this.yithWoocommerceWishlist});

  factory PluginModel.fromJson(Map<String, dynamic> json) {
    return PluginModel(
      acf: json['acf'] is int ? json['acf'] : null,
      bbpress: json['bbpress'] is int ? json['bbpress'] : null,
      bpBetterMessages: json['bp-better-messages'] is int ? json['bp-better-messages'] : null,
      buddypress: json['buddypress'] is int ? json['buddypress'] : null,
      wc4bp: json['wc4bp'] is int ? json['wc4bp'] : null,
      contactForm7: json['contact-form-7'] is int ? json['contact-form-7'] : null,
      elementor: json['elementor'] is int ? json['elementor'] : null,
      wooCommerceProductFilter: json['woocommerce-products-filter'] is int ? json['woocommerce-products-filter'] : null,
      iqonicExtensions: json['iqonic-extensions'] is int ? json['iqonic-extensions'] : null,
      iqonicModerationTools: json['iqonic-moderation-tool'] is int ? json['iqonic-moderation-tool'] : null,
      learnPress: json['learnpress-course-review'] is int ? json['learnpress-course-review'] : null,
      mailChimpForWordPress: json['mailchimp-for-wp'] is int ? json['mailchimp-for-wp'] : null,
      mediaPress: json['mediapress'] is int ? json['mediapress'] : null,
      miniOrangeLoginOpenId: json['miniorange-login-openid'] is int ? json['miniorange-login-openid'] : null,
      bpVerifiedMember: json['bp-verified-member'] is int ? json['bp-verified-member'] : null,
      wpStoryPremium: json['wp-story-premium'] is int ? json['wp-story-premium'] : null,
      wooSmartQuickView: json['woo-smart-quick-view'] is int ? json['woo-smart-quick-view'] : null,
      yithWoocommerceWishlist: json['yith-woocommerce-wishlist'] is int ? json['yith-woocommerce-wishlist'] : null,
    );
  }
  Map<String, dynamic> toJson() {
    return {
      'acf': acf,
      'bbpress': bbpress,
      'bp-better-messages': bpBetterMessages,
      'buddypress': buddypress,
      'wc4bp': wc4bp,
      'contact-form-7': contactForm7,
      'elementor': elementor,
      'woocommerce-products-filter': wooCommerceProductFilter,
      'iqonic-extensions': iqonicExtensions,
      'iqonic-moderation-tool': iqonicModerationTools,
      'learnpress-course-review': learnPress,
      'mailchimp-for-wp': mailChimpForWordPress,
      'mediapress': mediaPress,
      'miniorange-login-openid': miniOrangeLoginOpenId,
      'bp-verified-member': bpVerifiedMember,
      'wp-story-premium': wpStoryPremium,
      'woo-smart-quick-view': wooSmartQuickView,
      'yith-woocommerce-wishlist': yithWoocommerceWishlist
    };
  }
}
