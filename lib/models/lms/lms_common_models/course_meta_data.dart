class CourseMetaData {
  ...
  factory CourseMetaData.fromJson(Map<String, dynamic> json) {
    return CourseMetaData(
      ...
      lp_faqs: json['_lp_faqs'] != null && json['_lp_faqs'] != "" ? (json['_lp_faqs'] as List).map((i) => (i as List).toList()).toList() : null,
      lp_featured: json['_lp_featured'],
      lp_featured_review: json['_lp_featured_review'],
      lp_has_finish: json['_lp_has_finish'],
      lp_key_features: json['_lp_key_features'] != null && json['_lp_key_features'] != "" ? new List<String>.from(json['_lp_key_features']) : null,
      lp_level: json['_lp_level'],
      lp_max_students: json['_lp_max_students'],
      lp_no_required_enroll: json['_lp_no_required_enroll'],
      lp_passing_condition: json['_lp_passing_condition'] is int ? json['_lp_passing_condition'] : int.tryParse(json['_lp_passing_condition'].toString()),
      lp_regular_price: json['_lp_regular_price'],
      lp_requirements: json['_lp_requirements'] != null && json['_lp_requirements'] != "" ? new List<String>.from(json['_lp_requirements']) : null,
      ...
      lp_target_audiences: json['_lp_target_audiences'] != null && json['_lp_target_audiences'] != "" ? new List<String>.from(json['_lp_target_audiences']) : null,
    );
  }
