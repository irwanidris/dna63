...
import 'package:socialv/screens/gamipress/screens/achievement_list_screen.dart';
import 'package:socialv/screens/gamipress/screens/rank_list_screen.dart';
...
List<DrawerModel> getDrawerOptions() {
  ...
  if (appStore.pluginStatus.wpStoryPremium.getBoolInt())
    list.add(DrawerModel(
      image: ic_story,
      title: language.highlightStories,
      attachedScreen: HighlightStoryScreen(),
    ));
  if (appStore.showMemberShip && appStore.isMembershipEnable)
    list.add(DrawerModel(
  ...
  list.add(DrawerModel(
    ...
    attachedScreen: pmpStore.viewGroups ? GroupScreen(type: GroupRequestType.userGroup) : MembershipPlansScreen(),
  ));
  ...
  if (appStore.showGamiPress && appStore.isGamiPressEnable) {
    list.add(DrawerModel(
      image: ic_achievement,
      title: language.achievements,
      attachedScreen: AchievementScreen(),
    ));
    list.add(DrawerModel(
      image: ic_ranks,
      title: language.ranks,
      attachedScreen: RankScreen(),
    ));
  }

  if (appStore.showLearnPress && appStore.isCourseEnable) {
    list.add(DrawerModel(
      image: ic_book,
  ...
  if (appStore.showShop && appStore.showWoocommerce) {
    ...
    list.add(DrawerModel(
      image: ic_buy,
      title: language.myCart,
      attachedScreen: CartScreen(isFromHome: true),
    ));
    if (appStore.pluginStatus.yithWoocommerceWishlist.getBoolInt())
      list.add(DrawerModel(
        image: ic_heart,
...
List<DrawerModel> getCourseTabs() {
  ...
  if (appStore.pluginStatus.learnPress.getBoolInt()) list.add(DrawerModel(title: language.reviews));
...
List<FilterModel> getOrderStatus() {
  ...
  list.add(FilterModel(value: OrderStatus.any, title: language.all));
