...
class SharePreferencesKey {
  ...
  //region gamipress
  static const String achievementType = "gamipress_achievement_type";
  static const String pointsType = 'gamipress_points_type';
  static const String rankType = 'gamipress_ranks_type';
  ...
  static const String membershipEnable = 'membership_enable';
...
static const refreshToken = 'jwt-auth/v1/token/refresh';
  ...
  static const clearCart = 'socialv/api/v1/woocommerce/remove_all_item';
  static const relatedProducts = 'socialv/api/v1/woocommerce/related-product';
  static const recentlyViewedProducts = 'socialv/api/v1/woocommerce/recently-viewed';
  ...
  static const createHighlightEndPoint = 'socialv/api/v1/stories';
  static const userStoryEndPoint = 'user-story';
  static const reactionListEndPoint = 'story_reactions_list';
  static const saveStoryReactionEndPoint = 'save_story_reaction';
  static const getUserStoryReactionEndPoint = 'user_reaction';
  static const storyReplyEndPoint = 'story_reply';
  static const storiesListEndPoint = '';

  static const highlightEndPoint = 'highlights';

  static const highlightStoryListEndPoint = 'list-for-highlight';
...
//region Invoices
  static const membershipInvoice = 'socialv/api/v1/membership/get-invoice';
  static const courseInvoice = 'socialv/api/v1/learnpress/get-invoice';
  static const orderInvoice = 'socialv/api/v1/woocommerce/get-invoice';
//endregion
}
...
class MessageAPIEndPoint {
  ...
  static const unblockMember = 'socialv/api/v1/moderation/members';

  static const promoteAsAdmin = 'better-messages/v1/thread';
