...
ObservableList<PaypalPay> getPaypalDetails() {
  if (getStringAsync(SharePreferencesKey.paypal).validate().isNotEmpty) {
    Iterable list = jsonDecode(getStringAsync(SharePreferencesKey.paypal));
    return ObservableList.of(list.map((e) => PaypalPay.fromJson(e)).toList());
  }
  return ObservableList();
}
