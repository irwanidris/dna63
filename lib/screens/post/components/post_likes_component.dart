        ...
        children: [
            ...
            children: postLikeList.validate().take(3).map(
              (e) {
                return Container(
                  ...
                  decoration: BoxDecoration(border: Border.all(color: context.scaffoldBackgroundColor, width: 2)),
                  child: cachedImage(
          ...
          RichText(
            ...
            text: TextSpan(
              ...
              children: <TextSpan>[
                TextSpan(
                  text: postLikeList.first.userId.validate() == userStore.loginUserId ? ' ${language.you} ' : ' ${postLikeList.first.userName.validate()}',
