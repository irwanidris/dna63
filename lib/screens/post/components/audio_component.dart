...
class SeekBarState extends State<SeekBar> {
  ...
  HomeFragStore seekBarVars = HomeFragStore();
        ...
        SliderTheme(
          ...
          child: Observer(builder: (context) {
            return Slider(
              min: 0.0,
              max: widget.duration.inMilliseconds.toDouble(),
              value: min(seekBarVars.dragValue ?? widget.position.inMilliseconds.toDouble(), widget.duration.inMilliseconds.toDouble()),
              onChanged: (value) {
                seekBarVars.dragValue = value;
    ...
    builder: (context) => AlertDialog(
      ...
      content: StreamBuilder<double>(
        ...
        builder: (context, snapshot) => SizedBox(
          ...
          child: Column(
            children: [
              Text('${snapshot.data?.toStringAsFixed(1)}$valueSuffix', style: boldTextStyle(color: appStore.isDarkMode ? bodyDark : bodyWhite, size: 20)),
              Slider(
                divisions: divisions,
                min: min,
                max: max,
                ...
                inactiveColor: context.primaryColor.withValues(alpha: 0.5),
              ),
            ],
          ),
        ),
