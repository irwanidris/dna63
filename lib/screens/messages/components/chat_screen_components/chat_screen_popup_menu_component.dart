...
import '../../screens/participants_screen.dart' hide channel;
import '../add_new_participant_component.dart';

enum ChatScreenPopUpMenuComponentCallbacks { MuteOrUnMute, GetThread, DeleteThread }
        ...
        children: [
          ...
          PopupMenuButton(
                  ...
                  builder: (context) {
                    return FractionallySizedBox(
                      ...
                      child: AddNewParticipantComponent(
                        threadId: widget.threadId.validate(),
                        callback: () async {
                          await widget.callback?.call(ChatScreenPopUpMenuComponentCallbacks.GetThread);
            ...
            itemBuilder: (context) => <PopupMenuEntry>[
              ...
              if (widget.thread!.permissions!.deleteAllowed.validate() && (widget.user!.blocked != 1))
                PopupMenuItem(
                  value: 6,
                  child: TextIcon(
