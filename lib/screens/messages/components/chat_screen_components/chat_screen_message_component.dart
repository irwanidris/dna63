...
class _ChatScreenMessagesComponentState extends State<ChatScreenMessagesComponent> {
  ...
  void initState() {
    super.initState();
    textDate = widget.date == getChatDate(date: DateTime.now().toString()) ? language.today : widget.date.validate();
  }
                                  ...
                                  Wrap(
                                    children: [
                                      ...widget.meta!.reactions.validate().map((a) {
                                        int iconIndex = appStore.emojiList.indexWhere((e) => e.skins.validate().first.unified.validate() == a.reaction.validate());
                                        String x = appStore.emojiList[iconIndex].skins.validate().first.native.validate();
