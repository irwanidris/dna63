...
class _SingleChoiceComponentState extends State<SingleChoiceComponent> {
  ProfileMenuStore singleChoiceComponentVars = ProfileMenuStore();
  ...
  void initState() {
    ...
    if (widget.answered != null && widget.answered!.answered.validate().isNotEmpty) {
      singleChoiceComponentVars.selectedIndex = widget.options.indexWhere((element) => element.value.validate() == widget.answered!.answered.validate());
      ...
      if (lmsStore.quizList[index].answers.validate()[x].value.validate().isNotEmpty) {
        singleChoiceComponentVars.selectedIndex = widget.options.indexWhere((element) => element.value == lmsStore.quizList[index].answers.validate()[x].value.validate());
      }
    }
  }
        ...
        return InkWell(
          onTap: () {
            if (!widget.isReviewQuiz) {
              singleChoiceComponentVars.selectedIndex = i;
            ...
            child: Row(
              ...
              children: [
                Observer(builder: (context) {
                  return Icon(
                    singleChoiceComponentVars.selectedIndex == i ? Icons.check_circle_rounded : Icons.circle_outlined,
                    color: singleChoiceComponentVars.selectedIndex == i
                        ? appGreenColor
                        : appStore.isDarkMode
                            ? bodyDark
                            : bodyWhite,
