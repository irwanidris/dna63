              ...
              children: [
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        if (course.categories.validate().isNotEmpty && course.rating != 0) Text('|', style: secondaryTextStyle(fontFamily: fontFamily)).paddingSymmetric(horizontal: 14),
                        if (course.rating != 0)
                          Row(
                            children: [
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    cachedImage(ic_book, height: 19, width: 14, fit: BoxFit.contain, color: context.iconColor)
                  ],
                ),
                24.height,
              ],
