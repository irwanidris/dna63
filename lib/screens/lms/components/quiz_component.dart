...
class _QuizComponentState extends State<QuizComponent> {
  ProfileMenuStore quizComponentVars = ProfileMenuStore();
  ...
  startTimer() {
    timer = Timer.periodic(Duration(seconds: 1), (time) {
      ...
      if (showInHours) {
        quizComponentVars.timeToShow = hours.toString().padLeft(2, "0") + ':' + minutes.toString().padLeft(2, "0") + ":" + seconds.toString().padLeft(2, "0");
      } else {
        quizComponentVars.timeToShow = minutes.toString().padLeft(2, "0") + ":" + seconds.toString().padLeft(2, "0");
      }
    });
  }
              ...
              children: [
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text('${language.questions}:  ${quizComponentVars.quizPageIndex}/${widget.quiz.results!.results!.question_count.validate()}', style: primaryTextStyle(color: Colors.white)),
                      if (!widget.isReviewQuiz)
                        TextIcon(
                          text: quizComponentVars.timeToShow,
                  ...
                  child: Stack(
                    ...
                    children: [
                      PageView.builder(
                        ...
                        onPageChanged: (i) {
                          quizComponentVars.quizPageIndex = i + 1;
                        },
                        ...
                        child: Row(
                          children: [
                            Observer(builder: (context) {
                              return quizComponentVars.quizPageIndex > 1
                                  ? InkWell(
                              ...
                              child: Observer(builder: (context) {
                                return ListView.builder(
                                  ...
                                  itemBuilder: (ctx, index) {
                                    if ((index + 1) == quizComponentVars.quizPageIndex)
                                      return Container(
                            ...
                            16.width,
                            Observer(builder: (context) {
                              return quizComponentVars.quizPageIndex < widget.quiz.questions.validate().length
                                  ? InkWell(
                                      highlightColor: Colors.transparent,
                                      splashColor: Colors.transparent,
                                      onTap: () {
