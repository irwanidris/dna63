            ...
            if (data.orderItems.validate().isNotEmpty) ...[
              ...
              RichText(
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(
                      text: (data.orderItems.validate().first.salePrice.validate().isEmpty )
                          ? data.orderItems.validate().first.regularPrice.validate().isEmpty?language.free:"\$${data.orderItems.validate().first.regularPrice.validate()}"
                          : "\$${data.orderItems.validate().first.salePrice.validate()}",
