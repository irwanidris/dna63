...
class _MyStoryComponentState extends State<MyStoryComponent> {
  ...
  Widget build(BuildContext context) {
    return Observer(
      builder: (_) => Stack(
        children: [
          if (widget.list.isNotEmpty && !appStore.isLoading)
            AnimatedListView(
                      ...
                      Row(
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text('${(story.viewCount.validate() - (story.seen.validate() ? 1 : 0)).toString()} ${language.views}', style: boldTextStyle()),
