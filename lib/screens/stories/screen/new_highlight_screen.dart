...
class _NewHighlightScreenState extends State<NewHighlightScreen> {
  ...
  ProfileMenuStore newHighlightScreenVars = ProfileMenuStore();
  ...
  void initState() {
    ...
    if (widget.highlightList.isNotEmpty) {
      newHighlightScreenVars.highlightCategoryList.addAll(widget.highlightList);
      newHighlightScreenVars.highlightDropdownVal = widget.highlightList.validate().first;
      newHighlightScreenVars.showNewCategoryList = false;
    } else {
      newHighlightScreenVars.showNewCategoryList = true;
    }
  }
        ...
        child: Column(
          ...
          children: [
            Observer(builder: (context) {
              return newHighlightScreenVars.highlightCategoryList.isNotEmpty
                  ? Align(
                      alignment: Alignment.topRight,
                      child: TextButton(
                        onPressed: () {
                          newHighlightScreenVars.showNewCategoryList = !newHighlightScreenVars.showNewCategoryList;
                        },
                        child: Text(newHighlightScreenVars.showNewCategoryList ? language.selectHighlight : language.createNew, style: primaryTextStyle(color: context.primaryColor)),
                      ),
                    )
                  : Offstage();
            }),
            if (newHighlightScreenVars.highlightCategoryList.isEmpty) 16.height,
            if (newHighlightScreenVars.showNewCategoryList.validate())
              Column(
                mainAxisSize: MainAxisSize.min,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  ...
                  Observer(builder: (context) {
                    return DottedBorderWidget(
                      ...
                      child: newHighlightScreenVars.categoryImage == null
                          ? InkWell(
                              onTap: () async {
                                ...
                                if (file != null) {
                                  if (file == FileTypes.CAMERA) {
                                    await getImageSource().then((value) {
                                      ...
                                      newHighlightScreenVars.categoryImage = value;
                                    }).catchError((e) {
                                      appStore.setLoading(false);
                                    });
                                  } else {
                          ...
                          : Stack(
                              ...
                              children: [
                                cachedImage(
                                  newHighlightScreenVars.categoryImage!.path,
                                  height: 120,
                                  width: 120,
                                  fit: BoxFit.cover,
                                ...
                                Positioned(
                                  ...
                                  child: InkWell(
                                    onTap: () {
                                      newHighlightScreenVars.categoryImage = null;
                                    },
                                    child: Container(
                                      padding: EdgeInsets.all(6),
                                      decoration: BoxDecoration(color: Colors.grey.withValues(alpha: 0.7), shape: BoxShape.circle),
              ...
              Column(
                ...
                children: [
                  ...
                  Observer(builder: (context) {
                    return newHighlightScreenVars.highlightDropdownVal.id != null
                        ? Container(
                            width: context.width(),
                            ...
                            child: DropdownButtonHideUnderline(
                              child: ButtonTheme(
                                ...
                                child: DropdownButton<HighlightCategoryListModel>(
                                  ...
                                  value: newHighlightScreenVars.highlightDropdownVal,
                                  ...
                                  onChanged: (HighlightCategoryListModel? newValue) {
                                    newHighlightScreenVars.highlightDropdownVal = newValue!;
                                  },
                                  items: newHighlightScreenVars.highlightCategoryList.map<DropdownMenuItem<HighlightCategoryListModel>>((e) {
            ...
            AppButton(
              width: context.width(),
              onTap: () async {
                if (newHighlightScreenVars.showNewCategoryList) {
