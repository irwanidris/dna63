                ...
                children: [
                  Row(
                    ...
                    children: [
                      Row(
                        children: [
                          cachedImage(userStore.loginAvatarUrl != "" ? userStore.loginAvatarUrl : AppImages.defaultAvatarUrl, height: 62, width: 62, fit: BoxFit.cover).cornerRadiusWithClipRRect(100),
                          16.width,
                          Column(
                    ...
                    children: List.generate(options.length, (index) {
                      ...
                      return Observer(builder: (context) {
                        return SettingItemWidget(
                          decoration: BoxDecoration(color: appStore.selectedIndex == index ? context.primaryColor.withAlpha(30) : context.cardColor),
