                          ...
                          Column(
                            children: [
                              ...
                              Observer(builder: (context) {
                                return AppButton(
                                  onTap: !member.isRequested.validate()
                                      ? () async {
                                          ifNotTester(() async {
                                      ...
                                      : () {
                                          toast(language.requestAlreadySent);
                                        },
                                  text: member.isRequested.validate() ? language.requested : language.addFriend,
                              ...
                              onTap: () {
                                ifNotTester(() async {
                                  ...
                                  await removeSuggestedUser(userId: member.userId.validate()).then((value) {
                                    toast(language.userRemovedFromSuggestionsList, print: true);
                                    getDetails();
                                  }).catchError(onError);
                                });
                              },
