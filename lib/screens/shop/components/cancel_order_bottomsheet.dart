...
class _CancelOrderBottomSheetState extends State<CancelOrderBottomSheet> {
  ...
  ShopStore cancelOrderBottomSheetVars = ShopStore();

  @override
  void initState() {
    super.initState();
    cancelOrderBottomSheetVars.cancelOrderReason = cancelOrderList.first;
  }
                  ...
                  children: [
                      ...
                      itemBuilder: (context, index) {
                        return Observer(builder: (context) {
                          return GestureDetector(
                            onTap: () {
                              cancelOrderBottomSheetVars.cancelOrderReason = cancelOrderList[index];
                              print(cancelOrderBottomSheetVars.cancelOrderReason);
                              cancelOrderBottomSheetVars.cancelOrderIndex = index;
                            },
                            child: Row(
                              ...
                              children: [
                                Container(
                                  decoration: boxDecorationWithRoundedCorners(
                                    ...
                                    backgroundColor: cancelOrderBottomSheetVars.cancelOrderIndex == index ? context.primaryColor : context.cardColor,
                                  ),
                                  width: 16,
                                  height: 16,
                    ...
                    AppButton(
                      ...
                      onTap: () {
                        ...
                        widget.callback?.call(cancelOrderBottomSheetVars.cancelOrderReason);
                      },
                    ),
                    20.height,
                  ],
