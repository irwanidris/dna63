...
class CommentReplyNotificationComponent extends StatelessWidget {
  ...
  CommentReplyNotificationComponent({required this.element, this.callback, this.notificationTapCallback});

  @override
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        notificationTapCallback?.call();
            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  6.height,
                  Text(convertToAgo(element.date.validate()), style: secondaryTextStyle(size: 12)).paddingSymmetric(horizontal: 4),
                ],
                crossAxisAlignment: CrossAxisAlignment.start,
              ).expand(),
            ],
