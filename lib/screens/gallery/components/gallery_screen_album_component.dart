        ...
        Positioned(
          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                Text(widget.album.name.validate(), overflow: TextOverflow.ellipsis, style: boldTextStyle(size: 14, color: Colors.white)),
                Text(
                  widget.album.description.validate(),
                  maxLines: 2,
                  overflow: TextOverflow.ellipsis,
                  style: secondaryTextStyle(size: 12, color: Colors.white),
                ).paddingOnly(top: 2).visible(widget.album.description.validate().trim().isNotEmpty),
              ],
            ),
          ),
        ),
