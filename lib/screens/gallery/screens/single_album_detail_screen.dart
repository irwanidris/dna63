...
class _SingleAlbumDetailScreenState extends State<SingleAlbumDetailScreen> {
  GalleryStore mGalleryStore = GalleryStore();
  ...
  Future<void> init({bool showLoader = true, int page = 1}) async {
    ...
    future = await getAlbumDetails(
      ...
      page: page,
      albumMediaList: mGalleryStore.albumMediaList,
      lastPageCallback: (p0) {
        mIsLastPage = p0;
      },
    ).then((value) {
            ...
            Observer(builder: (context) {
              return SizedBox(
                ...
                child: NoDataWidget(
                  ...
                  title: mGalleryStore.errorText,
                  onRetry: () {
                    init();
                  },
                  retryText: '   ${language.clickToRefresh}   ',
                ).center(),
              ).visible(!appStore.isLoading && mGalleryStore.isErrorInGallery);
            }),
            ...
            Observer(builder: (context) {
              return AnimatedScrollView(
                ...
                children: [
                  ...
                  if (mGalleryStore.albumMediaList.isEmpty && !appStore.isLoading)
                    ...
                    GridView.builder(
                      itemCount: mGalleryStore.albumMediaList.length,
                      ...
                      itemBuilder: (context, index) {
                        AlbumMediaListModel media = mGalleryStore.albumMediaList[index];
