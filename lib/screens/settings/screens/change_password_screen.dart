  ...
  Future<void> changePass() async {
    ...
    ifNotTester(() async {
      ...
      if (changePassFormKey.currentState!.validate()) {
        ...
        if (oldPassCont.text == newPassCont.text) {
          toast(language.newPasswordDifferent);
          return;
        }
                ...
                child: Column(
                  children: [
                    AppTextField(
                      ...
                      validator: (value) {
                        if (value == null || value.trim().isEmpty) {
                          return language.oldPasswordRequired;
                        }
                        return null;
                      },
                    ...
                    AppTextField(
                      ...
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                          return language.newPasswordRequired;
                        }
                        if (value == oldPassCont.text) {
                          return language.newPasswordDifferent;
                        }
                        return null;
                      },
                      onChanged: (value) {
                    ...
                    AppTextField(
                      ...
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                          return language.confirmPasswordRequired;
                        }
                        if (value != newPassCont.text) {
                          return language.confirmPasswordError;
                        }
                        return null;
                      },
                      onChanged: (value) {
