...
class _PmpCheckoutScreenState extends State<PmpCheckoutScreen> {
  ...
  ProfileMenuStore pmpCheckoutScreenVars = ProfileMenuStore();
  String? discountCode;
  ...
  Future<void> onApplyDiscount() async {
    if (discountCodeController.text.isNotEmpty) {
      ...
      pmpCheckoutScreenVars.showAddDiscount = false;
    } else {
  ...
  Widget build(BuildContext context) {
    ...
    bool isFreePlan = plan!.isInitial.validate() ? plan!.initialPayment.validate() == 0 : plan!.billingAmount.validate() == 0;
    ...
    return AppScaffold(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            // Show discount section only if the plan is not free
            if (!isFreePlan)
              Observer(builder: (context) {
                return pmpCheckoutScreenVars.showAddDiscount
                    ? Column(
                        children: [
                          16.height,
                          Divider(height: 0),
                    ...
                    : Column(
                        ...
                        children: [
                          ...
                          TextButton(
                            onPressed: () {
                              pmpCheckoutScreenVars.showAddDiscount = true;
                            },
                            child: Text(
            ...
            // Show payment method section only if the plan is not free
            if (!isFreePlan)
              Container(
                width: context.width(),
                color: context.cardColor,
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (ctx, index) {
                        ...
                        if (temp.enable.getBoolInt())
                          return InkWell(
                            onTap: () {
                              if (appStore.selectedIndex != index) {
                            ...
                            child: Observer(builder: (context) {
                              return Container(
                                ...
                                decoration: BoxDecoration(
                                  border: Border.all(
                                    color: appStore.selectedIndex == index
                                  ...
                                  color: appStore.selectedIndex == index ? context.primaryColor.withAlpha(30) : context.cardColor,
                                  borderRadius: radius(commonRadius),
                                ),
                                child: Row(
                                  children: [
                                    Icon(
                                      appStore.selectedIndex == index ? Icons.radio_button_checked : Icons.circle_outlined,
                                      color: appStore.selectedIndex == index
                                          ? context.primaryColor
                                          : appStore.isDarkMode
                                              ? bodyDark
      ...
      bottomNavigationBar: Observer(builder: (context) {
        return appButton(
          text: isFreePlan ? language.proceed : language.makePayment,
          onTap: () {
            ...
            if (isFreePlan) {
              ...
              // Existing payment logic for non-free plans
                  ...
                  ifNotTester(() async {
                    if (payment!.id.validate() == PaymentIds.stripe) {
                      await stripeServices.init(
                        ...
                        context: context,
                        stripePaymentPublishKey: STRIPE_TEST_PUBLISHABLE_KEY,
                        ...
                        stripePaymentKey: STRIPE_TEST_PAYMENT_KEY,
