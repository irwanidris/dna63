...
class PmpOrderDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: AppScaffold(
        appBarTitle: language.membershipDetails,
        onBack: () {
          if (isFromCheckOutScreen) {
            push(DashboardScreen(), isNewTask: true);
          } else {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(language.membershipDetails, style: boldTextStyle(size: 18)),
                  Divider(height: 20),
                  ...
                  12.height.visible(orderDetail.membershipName != "Free"),
                  Text('${language.status}: ${language.paid}', style: primaryTextStyle()).visible(orderDetail.membershipName != "Free"),
                  12.height,
              ...
              return Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('${language.payVia}: ${orderDetail.gateway.capitalizeFirstLetter()}', style: primaryTextStyle()).paddingBottom(12),
            ...
            }).visible(orderDetail.membershipName != language.free),
            if (isFromCheckOutScreen)
              InkWell(
                onTap: () {
                ...
                child: Container(
                  ...
                  child: Text(language.goToHomePage, style: secondaryTextStyle(color: Colors.white)).center(),
                ),
              ),
          ],
