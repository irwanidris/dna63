...
class EditGroupSettingsScreen extends StatefulWidget {
  ...
  const EditGroupSettingsScreen({Key? key, required this.groupId, this.groupInviteStatus, this.isGalleryEnabled, required this.groupInvitations}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: CreateGroupStepSecond(
        ...
        groupInviteStatus: widget.groupInviteStatus.validate(),
        isGalleryEnabled: widget.isGalleryEnabled,
        groupInvitations: widget.groupInvitations,
      ),
    );
  }
}
