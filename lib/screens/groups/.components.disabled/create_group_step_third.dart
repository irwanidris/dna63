...
class _CreateGroupStepThirdState extends State<CreateGroupStepThird> {
  GroupStore createGroupStepThirdVars = GroupStore();
                ...
                children: [
                  ...
                  Observer(builder: (context) {
                    return Container(
                      height: 180,
                      width: context.width(),
                      child: createGroupStepThirdVars.avatarImage != null
                          ? Stack(
                              children: [
                                Image.file(
                                  createGroupStepThirdVars.avatarImage!,
                                  width: context.width(),
                                  fit: BoxFit.cover,
                                  ...
                                  child: Container(
                                    ...
                                    if (!appStore.isLoading)
                                      await deleteAvatarImage(id: groupId.toString().validate(), isGroup: true).then((value) {
                                        createGroupStepThirdVars.avatarImage = null;
                                      }).catchError((e) {
                                        toast(e);
                                      });
                                  }),
                                    ...
                                    await getImageSource(isCamera: file == FileTypes.CAMERA ? true : false).then((value) async {
                                      ifNotTester(() async {
                                        ...
                                        await groupAttachImage(id: groupId.validate(), image: value).then((_) {
                                          ...
                                          createGroupStepThirdVars.avatarImage = value;
                                        }).catchError((e) {
                                          appStore.setLoading(false);
                                        });
                                      });
                  ...
                  Observer(builder: (context) {
                    return Container(
                      height: 180,
                      width: context.width(),
                      child: createGroupStepThirdVars.coverImage != null
                          ? Stack(
                              children: [
                                Image.file(
                                  createGroupStepThirdVars.coverImage!,
                                  width: context.width(),
                                  fit: BoxFit.cover,
                                ).cornerRadiusWithClipRRect(defaultAppButtonRadius),
                                Positioned(
                                  ...
                                  child: Container(
                                    ...
                                    if (!appStore.isLoading)
                                      await deleteGroupCoverImage(id: groupId.validate()).then((value) {
                                        createGroupStepThirdVars.coverImage = null;
                                      }).catchError((e) {
                                    ...
                                    await getImageSource(isCamera: file == FileTypes.CAMERA ? true : false).then((value) async {
                                      ifNotTester(() async {
                                        ...
                                        await groupAttachImage(id: groupId.validate(), image: value, isCoverImage: true).then((_) {
                                          appStore.setLoading(false);
                                          createGroupStepThirdVars.coverImage = value;
                                        }).catchError((e) {
                                          appStore.setLoading(false);
                                          toast(language.somethingWentWrong);
                                        });
