        ...
        children: [
          ...
          RichText(
            text: TextSpan(
              ...
              children: <TextSpan>[
                TextSpan(
                  text: ' ${widget.data.isGroupAdmin.validate() ? '(${language.organizer})' : widget.data.isGroupMember.validate() ? '(${language.member})' : ''}',
          ...
          Row(
            ...
            children: [
              Image.asset(
                widget.data.groupType == "Private Group" ? ic_lock : widget.data.groupType == "Public Group" ?  ic_globe_antarctic:ic_hide,
                height: 16,
                width: 16,
                fit: BoxFit.cover,
